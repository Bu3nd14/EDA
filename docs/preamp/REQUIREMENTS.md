...
**Lo spegnimento** (ADR-046, L30). «Spegnimento» è quello dall'interruttore frontale, che è
morbido (P9, ADR-048): lì vale V2 per intero. La perdita di rete improvvisa e il guasto
