...
| L28 | **SS dell'LSK489 definito per l'LSK489.** Un documento del costruttore che dica cosa sono i pin 3 e 7 di *questa* parte — o una ADR che accetti l'istruzione dell'LSK389 in forza della compatibilità dichiarata. Prima di G2 | XS/S | NC-027 | da fare — **l'utente fa la ricerca** sui pin SS (2026-09-22); poi o un documento del costruttore in `vendor/`, o un'ADR che accetti l'istruzione dell'LSK389 |
