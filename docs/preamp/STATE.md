...
| **Prossimo lotto** | **L35 — comandi e LED a pannello nel sorgente** (ADR-028, NC-032): header di cablaggio al posto dei LED di trim e guadagno sulla scheda, SW1/SW2 a pannello (il cablaggio di SW2 esiste da L36), interruttore di mute combinato col temporizzatore d'accensione, LED rosso di mute letto da un contatto. Prima una decisione dell'utente sul residuo di L36. Prompt in `NEXT-SESSION.md` |
...
| L35 | **Comandi e LED a pannello nel sorgente** (ADR-028). Header di cablaggio al posto dei LED del trim sulla scheda (`trim.py`); comando del guadagno sul rotativo a 3 posizioni: **il cablaggio di SW2 esiste da L36** (4 poli, comando e ponte per bobina, ADR-026 provata dal 2e), resta portarlo a pannello coi LED del guadagno D7–D9; interruttore di mute combinato col temporizzatore d'accensione; LED rosso di mute, letto da un contatto che dica lo stato; `check_relay_safe_state.py` esteso. **Dopo L29 e L36**: il comando del guadagno si cabla una volta sola | S/M | **NC-032** | da fare — **prossimo**. Mandato in `NEXT-SESSION.md` |
