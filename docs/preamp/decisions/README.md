...
| [038](ADR-038-mute-graduale-ldr-a-monte.md) | Il mute graduale a monte: LDR in serie e verso massa all'ingresso del blocco A; il relè al jack resta e non taglia mai la musica; guadagno e trim si cambiano solo col jack a massa | accettata — nel sorgente con ADR-039 |
| [039](ADR-039-mute-ldr-nel-sorgente.md) | Il mute a LDR nel sorgente: due celle per canale, i LED in serie fra i canali sul cablaggio J3, il profilo v3 da 6 s come contratto del comando fuori scheda | accettata |
