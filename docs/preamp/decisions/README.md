...
| [038](ADR-038-mute-graduale-ldr-a-monte.md) | Il mute graduale a monte: LDR in serie e verso massa all'ingresso del blocco A; il relè al jack resta e non taglia mai la musica; guadagno e trim si cambiano solo col jack a massa | accettata — nel sorgente con ADR-039; la soglia di C tenuta qui è superata da ADR-040 |
