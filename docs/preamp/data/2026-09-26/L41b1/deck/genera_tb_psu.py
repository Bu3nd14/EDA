#!/usr/bin/env python3
"""L41b1: the supply board WITH its timer hardware, generated from circuits/preamp/psu.net.

Solo stdlib.
  /usr/bin/python3 genera_tb_psu.py --uscita <dir> --nome timer [--angolo min]
  /usr/bin/python3 genera_tb_psu.py --uscita <dir> --nome ldr [--cal <cal.json>] [--led max] [--v5 4.9]
...
ap.add_argument("--nome", choices=("timer", "ldr", "rumore"), required=True)
...
PUNTI = [("S", "d0", 20e-3), ("S", "d0.1", 0.2e-3), ("S", "d0.45", 4.5e-6),
         ("S", "d0.75", 0.19e-6), ("S", "riposo", 10e-9),
         ("P", "riposo", 10e-9), ("P", "d0.75", math.sqrt(10e-9 * 20e-3)),
         ("P", "d1", 20e-3),
